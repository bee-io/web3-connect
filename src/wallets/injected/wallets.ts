import type {BinanceProvider, CustomWindow, InjectedWalletModule} from './types'
import {InjectedNameSpace, ProviderIdentityFlag, ProviderLabel} from './types'
import {ChainId, ChainListener, createEIP1193Provider, EIP1193Provider, SimpleEventEmitter} from "../../common";
